...
public class ImageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(id != null){
			...
			List<String> list = getPicPath(request, response);
//			String picPath = "";
//			for (String string : list) {
//				picPath = picPath + string + " ";
//			}
			if(gsv.addPic(list, _id)){
				request.getRequestDispatcher("/jsp/seller/admin.jsp").forward(request, response);
			}
		}
	...
	public  List<String> getPicPath(HttpServletRequest request, HttpServletResponse response) throws IOException {
