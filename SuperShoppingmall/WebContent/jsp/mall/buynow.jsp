...
$(function() {
	...
	$('.addNum').click(function(){
		...
		$(".totalprice").text((price*1.0*(nownum*1.0)).toFixed(1));		
	...
	<div id="nowmain">
		...
		<div style="width: 100%;  height: 100px;float: right;margin-top: 5px;">
			<div
				...
				float: right;
				 ...
				 line-height: 35px;">
				<div>
					实付款: <span class="fcolor">￥</span> <span class="totalprice"
						style="color: #FF4450; font-size: 1.2em;">${item.goodsTotalPrice }</span><span></span>
				</div>
				<div>
		...
		<div style="width: 100%;height: 40px;float: right;">
			<div style="margin-top:10px; float: right;display: block;">
				...
				<input type="button"  value="${item.cartid }">
			</div>
		</div>
		<form id="form1" action="${pageContext.request.contextPath }/submitOrder?type=single" method="post">
