		...
		<div id="header">
			...
			<div id="aside">
				...
				<div>
					<ul>
						...
						<li><a href="${pageContext.request.contextPath }/orderList">已买到的宝贝</a></li>						
					</ul>
				</div>
				<div id="title">
			...
			<div id="section">
					...
					<div>
					 ...
					 <hr style="" color="#EE82EE" size="1" >
					<div>
						<input type="button" id="baseinfo" value="基本信息">
					 	<input type="button" id="logo" value="上传头像">
					</div>
					<hr  color="#EE82EE" size="1" >				
					<div>
						亲爱的<b><%=username %></b>，填写真实的资料，有助于好友找到你哦。
					</div>
					<form action="${pageContext.request.contextPath }/base" method="post">
					<div>
						<div >
						 	当前图标：
						 		<div style="position: relative;display: inline;margin-left: -5px;">
							 		 <img  id="useravatar" src="${pageContext.request.contextPath }/<%=u.getAvatar() %>" width="120px" height="120px">							 		
							 		<div id="editavatar" >
							 				<a  href="${pageContext.request.contextPath }/jsp/user/userAvatarSet.jsp?username=${user.username}">编辑头像</a>					 	
							 		</div>	
						 		</div>
						...
						<div >
							<label><em>*</em>&nbsp;昵称：&nbsp;&nbsp;&nbsp;&nbsp;</label> <input
								id="uniqueName" class="" name="nickname" type="text"
								value="<%=u.getNickname()==null ? "" : u.getNickname()%>"
								maxlength="25">
						</div >
						<div >
							<label>真实姓名：</label> <input id="realname" class=""
								name="realname" type="text"
								value="<%=u.getRealname() == null ? "" : u.getRealname() %>"
								maxlength="6">
						</div >
						<div >
							...
							<%
	                            	if (0 == u.getSex()) {
	                            %>
							<label for="J_gender1" class="except"><input
								id="J_gender1" type="radio" name="_fm.b._0.g" value="0"
								checked="checked" />男</label> <label for="J_gender2" class="except"><input
								id="J_gender2" type="radio" name="_fm.b._0.g" value="1" />女</label>
							<% } else { %>
							<label for="J_gender1" class="except"><input
								id="J_gender1" type="radio" name="_fm.b._0.g" value="0" />男</label> <label
								for="J_gender2" class="except"><input id="J_gender2"
								type="radio" name="_fm.b._0.g" value="1" checked="checked" />女</label>
							<% } %>
						...
						<div >
							<label>&nbsp;&nbsp;生日：&nbsp;&nbsp;&nbsp;&nbsp;</label> <input
								...
								value="<%=u.getBirthday()==null? "" : u.getBirthday() %>"
								class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
						</div >
						<div >
							<label>&nbsp;&nbsp;家乡：&nbsp;&nbsp;&nbsp;&nbsp;</label> <input
								id="hometown" class="" name="hometown" type="text"
					...
					<hr style=" margin-top:20px;width:98%;height:0.1px; "color=#F7F7F7></hr>
